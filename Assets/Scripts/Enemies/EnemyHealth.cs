...
public class EnemyHealth : MonoBehaviour
{
    ...
    public void Damage(int amount, bool isPlayerFacingLeft)
    {
        ...
        if (damageable && !hit && currentHealth > 0)
        {
            ...
            hit = true;
            //Knockback
            if(isPlayerFacingLeft) body.AddForce(Vector2.left * knockbackForce);
            else body.AddForce(Vector2.right * knockbackForce);
