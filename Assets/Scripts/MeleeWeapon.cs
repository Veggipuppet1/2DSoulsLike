...
public class MeleeWeapon : MonoBehaviour
{
    ...
    [SerializeField]
    private int strikeBounceHeight;
    ...
    private void HandleCollision(EnemyHealth objHealth)
    {
        ...
        objHealth.Damage(damageAmount, character.isFacingLeft);
    ...
    private void HandleMovement()
    {
        ...
        if (collided)
        {
            ...
            if (downwardStrike)
            {
                ...
                // rb.AddForce(direction * meleeAttackManager.upwardsForce, ForceMode2D.Force);
                rb.velocity = new Vector3(rb.velocity.x,strikeBounceHeight,0);
            ...
            else
            {
                ...
                // rb.velocity = new Vector3(rb.velocity.x,character.jumpheight,0);
            }
        }
    }
